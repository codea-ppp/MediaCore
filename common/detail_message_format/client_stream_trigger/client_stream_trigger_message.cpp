...
namespace media_core_message
{
	...
	int client_stream_trigger_message::full_data_remote(int sockfd, uint32_t tid, uint32_t)
	{
	...
	int client_stream_trigger_message::tell_me_type()
	{
		return MSGTYPE_CLIENTSTREAMTRIGGER;
	}
